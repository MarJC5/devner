import { _ as _sfc_main$5 } from './PageHeader-maaT1_jD.mjs';
import { _ as __nuxt_component_2$1 } from './Badge-OGRmTTcV.mjs';
import { s as selectMenu, a as __nuxt_component_2, u as useUI, b as useInjectButtonGroup, g as get, _ as __nuxt_component_3 } from './Button-CDYqYkPm.mjs';
import { useSSRContext, defineComponent, computed, ref, watch, provide, h as h$1, cloneVNode, reactive, toRaw, onMounted, Fragment, watchEffect, inject, onUnmounted, nextTick, toRef, unref, withCtx, openBlock, createBlock, createTextVNode, toDisplayString, createVNode, createCommentVNode, isRef, renderList, mergeProps, resolveComponent, resolveDynamicComponent, renderSlot, Transition } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttrs, ssrRenderClass, ssrRenderSlot, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderStyle } from 'vue/server-renderer';
import { _ as __nuxt_component_1 } from './Avatar-GrmG4wkZ.mjs';
import { A as A$1, o as o$1$1, u as u$4, t as t$4, i as i$5, E, T as T$1, I, s as s$1, N as N$1, l, a as l$1, b as useId, c as o$3 } from './keyboard-D9T68tnc.mjs';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { useDebounceFn, computedAsync } from '@vueuse/core';
import { t as defu } from '../runtime.mjs';
import { twMerge, twJoin } from 'tailwind-merge';
import { m as mergeConfig, b as appConfig, a as useRoute } from './server.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as _sfc_main$1$1, C as Container } from './Container-B3wCur7c.mjs';
import { _ as _sfc_main$6 } from './PageCard-NhNi6yJq.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const props = __props;
    const { ui, attrs } = useUI("dashboard.toolbar", toRef(props, "ui"), config2, toRef(props, "class"), true);
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@nuxt/ui-pro/components/dashboard/DashboardToolbar.vue");
...
function w(f2, m, l2 = computed(() => true)) {
  ...
  u$3("pointerdown", (e2) => {
    ...
    n() || u2.value && (a2(e2, () => u2.value), u2.value = null);
...
let ie = Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a2, { slots: h2 }) {
  ...
  let o2 = ref(1), u2 = ref(null), e$1 = ref(null), c$12 = ref(null), f2 = ref(null), S = ref({ static: false, hold: false }), v = ref([]), d2 = ref(null), D = ref(2), E$1 = ref(false);
  ...
  let M = computed(() => a2.multiple ? 1 : 0), $2 = computed(() => a2.nullable), [B, p2] = d$1(computed(() => a2.modelValue), (t2) => y2("update:modelValue", t2), computed(() => a2.defaultValue)), R = computed(() => B.value === void 0 ? u$4(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I2(t2) {
  ...
  let l2 = { comboboxState: o2, value: R, mode: M, compare(t2, n2) {
  ...
  }, defaultValue: computed(() => a2.defaultValue), nullable: $2, immediate: computed(() => false), virtual: computed(() => null), inputRef: e$1, labelRef: u2, buttonRef: c$12, optionsRef: f2, disabled: computed(() => a2.disabled), options: v, change(t2) {
    p2(t2);
  }, activeOptionIndex: computed(() => {
    if (E$1.value && d2.value === null && (l2.virtual.value ? l2.virtual.value.options.length > 0 : v.value.length > 0)) {
      if (l2.virtual.value) {
    ...
    E$1.value = false, V !== null && cancelAnimationFrame(V), V = requestAnimationFrame(() => {
      if (a2.disabled || f2.value && !S.value.static && o2.value === 1)
        return;
      if (l2.virtual.value) {
  ...
  w([e$1, c$12, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$4(computed(() => u$4(o2.value, { [0]: i$5.Open, [1]: i$5.Closed })));
  let g2 = computed(() => {
    var t2;
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && R.value != null ? e({ [t2]: R.value }).map(([q, ue]) => h$1(f$2, E({ features: u$1.Hidden, key: q, as: "input", type: "hidden", hidden: true, readOnly: true, form: s2, disabled: n2, name: q, value: ue }))) : [], A$1({ theirProps: { ...r2, ...T$1(b, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: O2, slots: h2, attrs: r2, name: "Combobox" })]);
  };
} });
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2 }) {
  ...
  return () => {
    let c2 = { open: o2.comboboxState.value === 0, disabled: o2.disabled.value }, { ...f2 } = a2, S = { id: y2, ref: o2.labelRef, onClick: u2 };
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2, expose: y2 }) {
  var S;
  let o2 = (S = a2.id) != null ? S : `headlessui-combobox-button-${I()}`, u2 = K("ComboboxButton");
  ...
  return () => {
    var E2, w2;
    let v = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a2, D = { ref: u2.buttonRef, id: o2, type: f2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E2 = o$1$1(u2.optionsRef)) == null ? void 0 : E2.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(w2 = o$1$1(u2.labelRef)) == null ? void 0 : w2.id, o2].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: c$12, onClick: e2 };
  ...
  var V;
  let u2 = (V = a2.id) != null ? V : `headlessui-combobox-input-${I()}`, e2 = K("ComboboxInput"), c$12 = computed(() => i$2(o$1$1(e2.inputRef))), f2 = { value: false };
  ...
  let v = computed(() => {
    ...
    return o$1$1(e2.inputRef) ? typeof a2.displayValue != "undefined" && i2 !== void 0 ? (I2 = a2.displayValue(i2)) != null ? I2 : "" : typeof i2 == "string" ? i2 : "" : "";
  });
  onMounted(() => {
    watch([v, e2.comboboxState, c$12], ([i2, I2], [T2, l2]) => {
      if (f2.value)
        return;
      let g2 = o$1$1(e2.inputRef);
      g2 && ((l2 === 0 && I2 === 1 || i2 !== T2) && (g2.value = i2), requestAnimationFrame(() => {
        var s2;
        if (f2.value || !g2 || ((s2 = c$12.value) == null ? void 0 : s2.activeElement) !== g2)
          return;
  ...
  function B(i2) {
    ...
    if (f2.value = false, !((l2 = o$1$1(e2.optionsRef)) != null && l2.contains(I2)) && !((g2 = o$1$1(e2.buttonRef)) != null && g2.contains(I2)) && e2.comboboxState.value === 0)
  ...
  function p2(i2) {
    var T2, l2, g2;
    let I2 = (T2 = i2.relatedTarget) != null ? T2 : t.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$1$1(e2.buttonRef)) != null && l2.contains(I2) || (g2 = o$1$1(e2.optionsRef)) != null && g2.contains(I2) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$2().nextFrame(() => {
  ...
  return () => {
    ...
    return A$1({ ourProps: g2, theirProps: l2, slot: i2, attrs: r2, slots: y2, features: N$1.RenderStrategy | N$1.Static, name: "ComboboxInput" });
  };
  ...
  let e2 = l(), c2 = computed(() => e2 !== null ? (e2.value & i$5.Open) === i$5.Open : o2.comboboxState.value === 0);
  ...
  return () => {
    ...
    return A$1({ ourProps: v, theirProps: d2, slot: S, attrs: h2, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r2, default: () => [h$1(Ae$1, {}, r2.default)] } : r2, features: N$1.RenderStrategy | N$1.Static, visible: c2.value, name: "ComboboxOptions" });
  };
  ...
  function D(p2) {
    p2.preventDefault(), p2.button === g$1.Left && (c$12.value || (o2.selectOption(u2), n() || requestAnimationFrame(() => {
      var R;
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r2, emit: w$12 }) {
  ...
  }, computed(() => n2.value === 0)), provide($, k), t$4(computed(() => u$4(n2.value, { [0]: i$5.Open, [1]: i$5.Closed })));
  let C = computed(() => {
    var t2;
  ...
  return onMounted(() => {
    ...
    return h$1(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I2, Q]) => h$1(f$2, E({ features: u$1.Hidden, key: I2, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I2, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r2, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h2, slots: b, attrs: r2, name: "Listbox" })]);
  };
} });
...
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r2, expose: w2 }) {
  ...
  return () => {
    var y2, L;
    let a2 = { open: e2.listboxState.value === 0, disabled: e2.disabled.value, value: e2.value.value }, { ...u2 } = o2, D = { ref: e2.buttonRef, id: n2, type: m.value, "aria-haspopup": "listbox", "aria-controls": (y2 = o$1$1(e2.optionsRef)) == null ? void 0 : y2.id, "aria-expanded": e2.listboxState.value === 0, "aria-labelledby": e2.labelRef.value ? [(L = o$1$1(e2.labelRef)) == null ? void 0 : L.id, n2].join(" ") : void 0, disabled: e2.disabled.value === true ? true : void 0, onKeydown: f2, onKeyup: v, onClick: s2 };
  ...
  let s2 = l(), m = computed(() => s2 !== null ? (s2.value & i$5.Open) === i$5.Open : e2.listboxState.value === 0);
  return () => {
    var y2, L;
  ...
  w2({ el: f2, $el: f2 });
  let v = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s2 = computed(() => u$4(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o2.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o2.value))) })), m = computed(() => u$4(e2.mode.value, { [1]: () => {
    var i2;
  ...
  function M(t2) {
    y2.wasMoved(t2) && (o2.disabled || v.value || e2.goToOption(c.Specific, n2, 0));
  }
  function k(t2) {
    y2.wasMoved(t2) && (o2.disabled || v.value && e2.goToOption(c.Nothing));
  }
  return () => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: logContainer,
        class: "h-[75vh] overflow-y-auto mt-4 p-4 rounded-lg bg-gray-100 dark:bg-gray-800"
      }, _attrs))}><!--[-->`);
      ssrRenderList(unref(logs), (log) => {
        _push(`<div class="log-entry">${ssrInterpolate(log)}</div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/LogViewer.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/LogTerminal.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const performContainerAction = async (container2, action) => {
      try {
        await container2[action]();
        loadContainer();
      } catch (error) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UPageHeader, {
        headline: unref(container) ? "" : "Loading...",
        class: "sticky top-0 bg-white z-10 dark:bg-gray-800 pb-4"
      }, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(container)) {
              _push2(`<h1 class="flex"${_scopeId}>${ssrInterpolate(unref(container).getName())} `);
              _push2(ssrRenderComponent(_component_UBadge, {
                label: unref(container).getStatus(),
                color: unref(container).isRunning() ? "green" : "red",
                class: "ml-2 h-6",
                variant: "soft"
            ...
            return [
              unref(container) ? (openBlock(), createBlock("h1", {
                key: 0,
                class: "flex"
              }, [
                createTextVNode(toDisplayString(unref(container).getName()) + " ", 1),
        ...
        description: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(container)) {
              ...
              if (!unref(container).isRunning()) {
                _push2(ssrRenderComponent(_component_UButton, {
                  onClick: () => performContainerAction(unref(container), "start"),
                  icon: unref(container).isLoading("start") ? "i-heroicons-spinner" : "i-heroicons-play",
                  size: "sm",
                  color: "white",
                  square: "",
                  variant: "solid",
                  loading: unref(container).isLoading("start"),
                  label: "Start"
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              ...
              if (unref(container).isRunning()) {
                _push2(ssrRenderComponent(_component_UButton, {
                  onClick: () => performContainerAction(unref(container), "restart"),
                  icon: unref(container).isLoading("restart") ? "i-heroicons-spinner" : "i-heroicons-arrow-path",
                  size: "sm",
                  color: "white",
                  square: "",
                  variant: "solid",
                  loading: unref(container).isLoading("restart"),
                  label: "Restart"
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              ...
              if (unref(container).isRunning()) {
                _push2(ssrRenderComponent(_component_UButton, {
                  onClick: () => performContainerAction(unref(container), "stop"),
                  icon: unref(container).isLoading("stop") ? "i-heroicons-spinner" : "i-heroicons-stop",
                  size: "sm",
                  color: "white",
                  square: "",
                  variant: "solid",
                  loading: unref(container).isLoading("stop"),
                  label: "Stop"
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              ...
              _push2(ssrRenderComponent(_component_UButton, {
                onClick: () => performContainerAction(unref(container), "remove"),
                icon: unref(container).isLoading("remove") ? "i-heroicons-spinner" : "i-heroicons-trash",
                size: "sm",
                color: "white",
                square: "",
                variant: "solid",
                loading: unref(container).isLoading("remove"),
                label: "Remove"
              }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_UButton, {
                onClick: () => performContainerAction(unref(container), "rebuild"),
                icon: unref(container).isLoading("rebuild") ? "i-heroicons-spinner" : "i-heroicons-arrow-path-rounded-square",
                size: "sm",
                color: "white",
                square: "",
                variant: "solid",
                loading: unref(container).isLoading("rebuild"),
                label: "Rebuild"
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
            ...
            return [
              unref(container) ? (openBlock(), createBlock("div", {
                key: 0,
                class: "flex flex-wrap gap-2"
              }, [
                !unref(container).isRunning() ? (openBlock(), createBlock(_component_UButton, {
                  key: 0,
                  onClick: () => performContainerAction(unref(container), "start"),
                  icon: unref(container).isLoading("start") ? "i-heroicons-spinner" : "i-heroicons-play",
                  size: "sm",
      ...
      if (unref(container)) {
        _push(`<div>`);
        _push(ssrRenderComponent(_component_UDashboardToolbar, { class: "pl-0 py-4" }, {
          left: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selected) !== "Shell") {
                _push2(ssrRenderComponent(_component_USelectMenu, {
                  icon: unref(selected) === "General" ? "i-heroicons-information-circle" : "i-heroicons-clipboard-document-list",
              ...
              return [
                unref(selected) !== "Shell" ? (openBlock(), createBlock(_component_USelectMenu, {
                  key: 0,
                  icon: unref(selected) === "General" ? "i-heroicons-information-circle" : "i-heroicons-clipboard-document-list",
                  modelValue: unref(selected),
                  "onUpdate:modelValue": ($event) => isRef(selected) ? selected.value = $event : null,
                  options: status,
                  color: "white"
                }, null, 8, ["icon", "modelValue", "onUpdate:modelValue"])) : createCommentVNode("", true),
                unref(selected) !== "Shell" ? (openBlock(), createBlock(_component_UButton, {
                  key: 1,
                  icon: "i-heroicons-command-line",
                  size: "sm",
                  color: "white",
        ...
        if (unref(selected) === "General") {
          _push(`<div class="mt-4">`);
          _push(ssrRenderComponent(_component_UPageGrid, { ui: {
            wrapper: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-8"
          } }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(_component_UPageCard, { title: "General" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p${_scopeId2}>Name: ${ssrInterpolate(unref(container).getName())}</p><p class="truncate"${_scopeId2}>Image: ${ssrInterpolate(unref(container).getImage())}</p><p${_scopeId2}>Created: ${ssrInterpolate(unref(container).getCreated())}</p>`);
                    } else {
                      return [
                        createVNode("p", null, "Name: " + toDisplayString(unref(container).getName()), 1),
                        createVNode("p", { class: "truncate" }, "Image: " + toDisplayString(unref(container).getImage()), 1),
                        createVNode("p", null, "Created: " + toDisplayString(unref(container).getCreated()), 1)
                      ];
                    }
                  }),
                  _: 1
                }, _parent2, _scopeId));
                _push2(ssrRenderComponent(_component_UPageCard, { title: "Network" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(` Ports: <ul${_scopeId2}><!--[-->`);
                      ssrRenderList(unref(container).getPorts(), (port) => {
                        _push3(`<li${_scopeId2}>${ssrInterpolate(port)}</li>`);
                      });
                      _push3(`<!--]--></ul>`);
                    } else {
                      return [
                        createTextVNode(" Ports: "),
                        createVNode("ul", null, [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(container).getPorts(), (port) => {
                            return openBlock(), createBlock("li", { key: port }, toDisplayString(port), 1);
                          }), 128))
                        ])
                      ];
                    }
                ...
                return [
                  createVNode(_component_UPageCard, { title: "General" }, {
                    default: withCtx(() => [
                      createVNode("p", null, "Name: " + toDisplayString(unref(container).getName()), 1),
                      createVNode("p", { class: "truncate" }, "Image: " + toDisplayString(unref(container).getImage()), 1),
                      createVNode("p", null, "Created: " + toDisplayString(unref(container).getCreated()), 1)
                  ...
                  createVNode(_component_UPageCard, { title: "Network" }, {
                    default: withCtx(() => [
                      createTextVNode(" Ports: "),
                      createVNode("ul", null, [
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(container).getPorts(), (port) => {
        ...
        if (unref(selected) === "Logs") {
          _push(`<div class="mt-4">`);
          _push(ssrRenderComponent(_sfc_main$2, {
            containerId: unref(container).getId()
          }, null, _parent));
          _push(`</div>`);
        } else {
          _push(`<!---->`);
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Loading container... `);
            } else {
              return [
                createTextVNode(" Loading container... ")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/container/Single.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Single-DdSTO5kM.mjs.map
