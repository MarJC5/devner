import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { Server as Server$2 } from 'node:http';
...
import { Server } from 'file:///app/node_modules/engine.io/wrapper.mjs';
import { Server as Server$1 } from 'file:///app/node_modules/socket.io/wrapper.mjs';
...
const _lazy_nhpdVG = () => Promise.resolve().then(function () { return logs$1; });
const _lazy_47iozw = () => Promise.resolve().then(function () { return rebuild$1; });
...
const server = new Server$2(toNodeListener(nitroApp.h3App));
{
...
const containers$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: containers
});
...
const details$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: details
});
...
const exec$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: exec
});
...
const rebuild = defineEventHandler(async (event) => {
  if (event.node.req.method !== "POST") {
    return { status: "error" };
  }
  const { id } = event.context.params;
...
const rebuild$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: rebuild
});
...
const remove$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: remove
});
...
const restart$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: restart
});
...
const start$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: start
});
...
const stop$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: stop$2
});

const create$4 = defineEventHandler(async (event) => {
  if (event.node.req.method !== "POST") {
    return { status: "error" };
  }
...
const stop$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: stop
});

const create$2 = defineEventHandler(async (event) => {
  if (event.node.req.method !== "POST") {
    return { status: "error" };
  }
  const body = await readBody(event);
...
const create$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: create$2
});
