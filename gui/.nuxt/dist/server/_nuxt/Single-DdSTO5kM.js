import { _ as _sfc_main$5 } from "./PageHeader-maaT1_jD.js";
import { _ as __nuxt_component_2$1 } from "./Badge-OGRmTTcV.js";
import { u as useUI, s as selectMenu, a as __nuxt_component_2, b as useInjectButtonGroup, g as get, _ as __nuxt_component_3 } from "./Button-CDYqYkPm.js";
import { defineComponent, toRef, mergeProps, unref, useSSRContext, ref, computed, onUnmounted, watchEffect, watch, provide, h as h$1, cloneVNode, reactive, toRaw, onMounted, Fragment, inject, nextTick, resolveComponent, createVNode, resolveDynamicComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, renderList, createTextVNode, Transition, isRef } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderSlot, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle } from "vue/server-renderer";
import { _ as __nuxt_component_1 } from "./Avatar-GrmG4wkZ.js";
import { o as o$3, u as u$4, A as A$1, t as t$4, i as i$5, E, T as T$1, I, s as s$1, N as N$1, l, a as o$4, b as l$1, c as useId } from "./keyboard-D9T68tnc.js";
...
import { _ as _sfc_main$6, C as Container } from "./Container-B3wCur7c.js";
import { _ as _sfc_main$7 } from "./PageCard-NhNi6yJq.js";
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2, expose: y2 }) {
  ...
  return () => {
    var E2, w2;
    let v = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a2, D = { ref: u2.buttonRef, id: o2, type: f2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E2 = o$3(u2.optionsRef)) == null ? void 0 : E2.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(w2 = o$3(u2.labelRef)) == null ? void 0 : w2.id, o2].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: c$12, onClick: e2 };
  ...
  var V;
  let u2 = (V = a2.id) != null ? V : `headlessui-combobox-input-${I()}`, e2 = K("ComboboxInput"), c$12 = computed(() => i$2(o$3(e2.inputRef))), f2 = { value: false };
  ...
  onMounted(() => {
    watch([v, e2.comboboxState, c$12], ([i2, I2], [T2, l2]) => {
      ...
      g2 && ((l2 === 0 && I2 === 1 || i2 !== T2) && (g2.value = i2), requestAnimationFrame(() => {
        var s2;
        if (f2.value || !g2 || ((s2 = c$12.value) == null ? void 0 : s2.activeElement) !== g2) return;
  ...
  function B(i2) {
    ...
    if (f2.value = false, !((l2 = o$3(e2.optionsRef)) != null && l2.contains(I2)) && !((g2 = o$3(e2.buttonRef)) != null && g2.contains(I2)) && e2.comboboxState.value === 0) return i2.preventDefault(), e2.mode.value === 0 && (e2.nullable.value && e2.value.value === null ? S() : e2.activationTrigger.value !== 1 && e2.selectActiveOption()), e2.closeCombobox();
  }
  function p2(i2) {
    var T2, l2, g2;
    let I2 = (T2 = i2.relatedTarget) != null ? T2 : t.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$3(e2.buttonRef)) != null && l2.contains(I2) || (g2 = o$3(e2.optionsRef)) != null && g2.contains(I2) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$2().nextFrame(() => {
  ...
  i({ container: computed(() => o$3(o2.optionsRef)), enabled: computed(() => o2.comboboxState.value === 0), accept(S) {
  ...
  return () => {
    var D, E2, w2;
    let S = { open: o2.comboboxState.value === 0 }, v = { "aria-labelledby": (w2 = (D = o$3(o2.labelRef)) == null ? void 0 : D.id) != null ? w2 : (E2 = o$3(o2.buttonRef)) == null ? void 0 : E2.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0, onMousedown: f2 }, d2 = T$1(a2, ["hold"]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UPageCard = _sfc_main$7;
      _push(`<!--[-->`);
...
//# sourceMappingURL=Single-DdSTO5kM.js.map
