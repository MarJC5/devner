<template>
  ...
  <div v-if="container">
    ...
    <div v-if="selected === 'General'" class="mt-4">
    ...
    <div v-if="selected === 'Logs'" class="mt-4">
      <LogViewer :containerId="container.getId()" />
    </div>
    <div v-if="selected === 'Shell'" class="mt-4">
...
onMounted(() => {
  containersStore.fetchContainer(route.params.id);
});

const container = computed(() => containersStore.container);
