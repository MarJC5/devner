import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, toRef, isRef, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, p as defuFn, q as klona, t as defu, v as sanitizeStatusCode, x as createDefu, y as createHooks, i as createError$1, z as toRouteMatcher, A as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    name: "containers-id",
    path: "/containers/:id()",
    component: () => import('./_id_-B9_h0gt6.mjs').then((m) => m.default || m)
  },
  {
    name: "containers",
    path: "/containers",
    component: () => import('./index-DEQ1UpHo.mjs').then((m) => m.default || m)
  },
  {
    name: "databases-type-name",
    path: "/databases/:type()/:name()",
    component: () => import('./_name_-nM3bTeGR.mjs').then((m) => m.default || m)
  },
  {
    name: "databases",
    path: "/databases",
    component: () => import('./index-D4l6GGLT.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B4_J2A2U.mjs').then((m) => m.default || m)
  },
  {
    name: "other-containers-id",
    path: "/other-containers/:id()",
    component: () => import('./_id_-CBOd56-0.mjs').then((m) => m.default || m)
  },
  {
    name: "other-containers",
    path: "/other-containers",
    component: () => import('./index-lwer3w52.mjs').then((m) => m.default || m)
  },
  {
    name: "projects-name",
    path: "/projects/:name()",
    component: () => import('./_name_-BPaDO-kv.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./index-DYQSQoAl.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-Dm7V5HYH.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-rKCVmMF7.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-iW-ycMlB.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DLw0cgPK.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-B-6WuaCl.mjs').then((r) => r.default || r));
...
export { useRoute as a, appConfig as b, useAppConfig as c, useNuxtApp as d, entry$1 as default, useRouter as e, navigateTo as f, useRuntimeConfig as g, useState as h, mergeConfig as m, nuxtLinkDefaults as n, resolveRouteObject as r, useHead as u };
